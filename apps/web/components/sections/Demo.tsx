  ...
  return (
    ...
    <section id="demo" className="relative w-full bg-[#0a1128] py-20 lg:py-28">
      <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto mt-12 flex w-full max-w-7xl flex-col gap-6 lg:mt-16 lg:flex-row">

          {/* Card 1: Selection Map */}
          <div
            className={`group relative flex w-full flex-none flex-col overflow-hidden rounded-3xl bg-white p-6 transition-all duration-1100 ease-spring hover:shadow-[0_8px_40px_rgba(255,255,255,0.08)] sm:p-8 md:p-10 lg:px-12 lg:py-10 ${step === 1 ? 'lg:flex-[1.5]' : 'lg:flex-[1]'}`}
          >
            <div className="relative z-20">
              <DottedNumber num="1" />
            </div>

            {/* Step Animations Wrapper using Grid Stacking for native height flow */}
            <div className="relative z-10 grid flex-1">
              ...
              <div className={`col-start-1 row-start-1 flex flex-col transition-all duration-900 ease-spring ${step === 1 ? 'z-10 opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none max-lg:hidden'}`}>
                ...
                {/* Anchored Next button - flex flow on mobile, absolute flush corner on desktop */}
                <div className="mt-8 flex justify-end md:absolute md:bottom-0 md:right-0 md:mt-0">
                  <Button
                    onClick={() => setStep(2)}
          ...
          {/* Card 2: Form Display */}
          <div
            className={`group relative flex w-full flex-none flex-col overflow-hidden rounded-3xl bg-white p-6 transition-all duration-1100 ease-spring hover:shadow-[0_8px_40px_rgba(255,255,255,0.08)] sm:p-8 md:p-10 lg:px-12 lg:py-10 ${step === 1 ? 'lg:flex-[1]' : 'lg:flex-[1.5]'}`}
          >
            <div className="relative z-20">
              <DottedNumber num="2" />
            </div>
                  ...
                  <div className="w-full md:w-[55%]">
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                      <div className="space-y-1.5">
                        ...
                        <div className="flex cursor-not-allowed items-center justify-between border-b border-slate-200 py-2 text-[15px] font-medium text-slate-900" aria-disabled="true">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-auto w-full rounded-none border-0 border-b border-slate-200 bg-transparent px-0 py-2 text-[15px] font-medium text-slate-900 shadow-none placeholder:text-slate-400 outline-none transition-all focus-visible:border-[#0a1128] focus-visible:ring-0"
                        />
                      </div>
                      <div className="space-y-1.5">
