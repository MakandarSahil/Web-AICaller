      ...
      <div className="flex flex-col flex-1 min-w-0 bg-background h-full font-sans transition-colors duration-300">
        <header className="page-header shrink-0 px-6 border-b border-border/40 bg-background/95 backdrop-blur-md sticky top-0 z-40">
          <div className="flex items-center gap-4 flex-1">
            <h1 className="page-title leading-none text-[15px] font-bold tracking-tight text-foreground">Chat History</h1>
            ...
            <CardContent className="pt-24 pb-24">
              <div className="text-center flex flex-col items-center">
                <div className="h-12 w-12 rounded-full bg-muted flex items-center justify-center mb-4 border border-border/40">
                  <MessageSquareText size={20} className="text-muted-foreground/60" />
                </div>
                <h3 className="text-sm font-bold text-foreground">Chat history placeholder</h3>
                <p className="text-xs text-muted-foreground/70 mt-1 max-w-[260px]">Recent chats with agents will appear here with searchable transcripts.</p>
              </div>
            </CardContent>
          </Card>
        </div>
